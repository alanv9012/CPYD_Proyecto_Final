-- Create global views on Node 1
-- Node 1 has Region A locally, queries Region B from Node 2

SET SERVEROUTPUT ON;

PROMPT Creating Global Views on Node 1...
...
PROMPT Global views created on Node 1!
EXIT;
